...
rep_dirs = [i for i in os.listdir("../test_batch_h5ad_v2/") if os.path.isdir("../test_batch_h5ad_v2/" + i)]

for rep_dir in rep_dirs:

    h5ad_files = [i for i in os.listdir("../test_batch_h5ad_v2/" + rep_dir + "/") if i.endswith(".h5ad")]

    # load data and set up celldrift object
    for h5ad_file in h5ad_files:
        batch_size = h5ad_file.split("sim_batchLoc_")[1].split(".h5ad")[0]
        odata = sc.read("../test_batch_h5ad_v2/" + rep_dir + "/" + h5ad_file)
        ...
        adata.write("ct_output_batch_" + str(batch_size) + ".h5ad")

    ct_files = [i for i in os.listdir("./") if i.endswith(".h5ad")]

    df_pairwise = pd.DataFrame()
    for ct_file in ct_files:
        adata = sc.read(ct_file)
        batch_facloc = str(ct_file.split("ct_output_batch_")[1].split(".h5ad")[0])
        ...
        df_sub["Batch_FacLoc"] = batch_facloc
