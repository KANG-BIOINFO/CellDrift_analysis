...
alphas = [0.3] * 3 + [1] + [0.3] * 5
methods = ['kmeans','kmeans_DEGs_t-test', 'kmeans_fuzzy_DEGs_t-test','kmeans_fuzzy', 'kmeans_DEGs_wilcoxon',
            'kmeans_fuzzy_DEGs_wilcoxon', 'FPCA_EMCluster', 'FPCA_EMCluster_t-test', 'FPCA_EMCluster_wilcoxon']
...
for covariate_name in covariate_names:
    ...
    fig.savefig('figures/benchmark_' + covariate_name + '.pdf', bbox_inches = 'tight')
