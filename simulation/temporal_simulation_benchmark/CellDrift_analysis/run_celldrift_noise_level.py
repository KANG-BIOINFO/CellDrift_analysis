...
def run_celldrift(adata, suffix_add):
    ...
    for timepoint in np.unique(adata.obs['time']):
        ...
        adata_time = ct.model_genes(adata_time, n_processes = 4, chunksize=15, pairwise_contrast_only = True, adjust_batch = False, output_suffix = '_' + suffix_name)
...
if __name__ == '__main__':
    ...
    for h5ad_file in h5ad_files:
        ...
        # noise_level = int(suffix.split('noise_')[1])
